...
from magic.config import bot_config
from magic.version import __version__
from magic.permission import ADMIN, HELPER
from magic.utils.helpers import HandleCancellation
from magic.utils.update import CheckUpdate, update
