...
如遇滥用、骚扰等不当行为，请通过 issue 向我们举报。我们将迅速审议并调查全部投诉。
...
本行为标准改编自 [参与者公约2.0][homepage] 版，可在此查阅：[https://www.contributor-covenant.org/zh-cn/version/2/0/code_of_conduct.html][v2.0]
